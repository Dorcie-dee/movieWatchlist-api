...
Here, a user can register on the platform and also gain access into their dashboard by logging into our system.
...
Likewise, a user can [update] the status of a movie in their collection by specifying whether it has been watched or not.
...
PATCH
[update] movie
**https://moviewatchlist-api.onrender.com/api/movies/{movieId}**
...
status (string): The current status of the movie (e.g., "watched", "watching", "to watch"). 
